...
| :----: | :---------------------- |
| **A2** | [A3](https://github.com/Hitro147/marc_chess_copy/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A2+to+A3), [A4](https://github.com/Hitro147/marc_chess_copy/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A2+to+A4) |
...
| Move | Author |
| :--: | :----- |
| `Start game` | [ @Hitro147](https://github.com/Hitro147) |
...
| Total moves |  User  |
| :---------: | :----- |
| 1 | [@Hitro147](https://github.com/Hitro147) |
