...
| **5** | <img src="." width=50px> | <img src="." width=50px> | <img src="." width=50px> | <img src="." width=50px> | <img src="." width=50px> | <img src="." width=50px> | <img src="." width=50px> | <img src="." width=50px> | **5** |
...
| **7** | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | <img src="Pawn_B" width=50px> | **7** |
...
|  FROM  | TO |
| :----: | :-------------- |
| **A7** | [A5](https://github.com/Hitro147/marc_chess_copy/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A7+to+A5), [A6](https://github.com/Hitro147/marc_chess_copy/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+A7+to+A6) |
